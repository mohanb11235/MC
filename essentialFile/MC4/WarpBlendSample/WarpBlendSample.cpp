	...
	for (gpu = 0; gpu < gpuCount; gpu++)
	{
		...
		for (int dispIndex = 0; (dispIndex < dispIdCount) && dispIds[dispIndex].isActive; dispIndex++)
		{
				...
				//     x                        y                  u                           v                   r       q
			{
				...
				304,	                 246,			(srcLeft_1)*1.0,					    (srcTop_1)*1.0,			           0.0f,	 1.0f*1.0f,     // 0
				320,                     1005,	        (srcLeft_1)*1.0,					    (srcTop_1 + srcHeight_1)*1.0,	   0.0f,	 1.0f*1.0f,     // 1
				1919,	                 288,			(srcLeft_1 + srcWidth_1)*1.0,			(srcTop_1)*1.0,				       0.0f,	 1.0f*1.0f,      // 2
				1919,	                 1006,	        (srcLeft_1 + srcWidth_1)*1.0,			(srcTop_1 + srcHeight_1)*1.0,	   0.0f,	 1.0f*1.0f,     // 3
			};
				...
				//     x                        y                  u                           v                   r       q
			{
				...
				2,	              394,			    srcLeft_1,					srcTop_1,				0.0f,	 1.0*1.0f,     // 0
				124,              1079,	            srcLeft_1,					srcTop_1 + srcHeight_1,	0.0f,	 1.0*1.0f,     // 1
				1882,	          334,			    srcLeft_1 + srcWidth_1,		srcTop_1,				0.0f,	 1.0*1.0f,      // 2
				1916,	          1040,	            srcLeft_1 + srcWidth_1,		srcTop_1 + srcHeight_1,	0.0f,	 1.0*1.0f,     // 3
			};
				...
				//     x                        y                  u                           v                   r       q
			{
				...
				14,	                53,			        srcLeft_1,					srcTop_1,				            0.0f,	 1.0*1.0f,     // 0
				0,                  930,	            srcLeft_1,					srcTop_1 + srcHeight_1,	            0.0f,	 1.0*1.0f,     // 1
				1918,	            1,			        srcLeft_1 + srcWidth_1,		srcTop_1,				            0.0f,	 1.0*1.0f,      // 4
				1838,	            894,	            srcLeft_1 + srcWidth_1,		srcTop_1 + srcHeight_1,	            0.0f,	 1.0*1.0f,     // 3
			};
				...
				//     x                        y                  u                           v                   r       q
			{
				...
				19,	              236,			    0,					0,				1.0f,	 1.49412*1.0f,     // 0
				1,                1067,	            0,			        1080,	        1.0f,	 1.54608*1.0f,     // 1
				1766,	          275,			    1920,		        0,				1.0f,	 1.45392*1.0f,      // 2
				1917,	          1082,	            1920,		        1080,	        1.0f,	 1.50583*1.0f,     // 3
			};
				...
				//     x                        y                  u                           v                   r       q
			{
				...
				208,	                60,			        1920,					0,				            0.0f,	 1.0*1.0f,     // 0
				0,                      977,	            1920,					1080,	                    0.0f,	 1.0*1.0f,     // 1
				1893,	                0,			        3840,		            0,				            0.0f,	 1.0*1.0f,      // 4
				1913,	                954,	            3840,		            1080,	                    0.0f,	 1.0*1.0f,     // 3
			};
